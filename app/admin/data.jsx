...
(function () {
  ...
  function recentDocumentHitToResult(hit) {
    ...
    const docText = hit.text_preview || "";
  ...
  window.XCN = Object.assign(state, {
    api, loadInitial, loadSecurityInsight, loadSecurityInsightHistory, loadLogs, loadHighRiskLogs, fetchDocumentChunks, fetchLogChunks,

...
function Search({ onMatch, toast }) {
  ...
  return h("div", { className: "view split search-workspace" },
    h("section", { className: "panel", style: { overflow: "hidden" } },
      ...
      h("div", { style: { padding: "var(--pad)", display: "flex", flexDirection: "column", gap: 14 } },
        h("div", { className: "seg" },
          ...
          return h("article", { className: "result result-risk-" + risk.key + (i === selectedIndex ? " active" : ""), key: m.id, onClick: () => setSelectedIndex(i) },
            h("div", { className: "result-top" },
              ...
              h("div", { className: "result-id" },
                h("div", { className: "rt" }, h(TitleKind, { kind: mode === "docs" ? "등록문서" : XCN.logTitleKind(log.metadata || m.metadata) }), h("span", null, mode === "docs" ? m.doc_title : logDisplayName(m, log)), mode === "docs" && h(SecPill, { level: m.doc_security })),
...
Object.assign(window, { Dashboard, SecurityInsights, Documents, Search, Logs });

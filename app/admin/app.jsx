...
const NAV = [
  ...
  { id: "kafka", label: "Kafka 결과", icon: "database", badge: null },
...
const TITLES = {
  ...
  kafka: ["Kafka Delivery Results", "Kafka 결과"],
...
function App() {
  ...
  const ViewComp = { dashboard: Dashboard, insights: SecurityInsights, documents: Documents, search: Search, logs: Logs, kafka: KafkaResults, operations: Operations }[view];
